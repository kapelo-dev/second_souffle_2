...
export default function Navigation() {
  ...
  return (
    <>
      <nav className="fixed top-0 left-0 right-0 bg-[#FAF9F6] z-[100] border-b border-[#E5E5E5]">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="h-20 flex items-center justify-between relative">
            ...
            <button
              ...
              className="block lg:hidden w-8 h-8 relative z-50"
              aria-label="Menu"
            >
          ...
          {/* Mobile Menu */}
          {isMenuOpen && (
            <div className="lg:hidden fixed top-20 left-0 right-0 bottom-0 bg-[#FAF9F6] border-t border-[#E5E5E5] z-40">
      ...
      {/* Spacer pour éviter que le contenu ne soit caché derrière la navigation fixe */}
