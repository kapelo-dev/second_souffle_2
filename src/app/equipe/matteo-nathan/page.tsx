...
export default function MatteoNathan() {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            <div>
              ...
              <div className="space-y-4">
                <h1 className="text-4xl font-serif text-black">Mattéo Nathan</h1>
                <p className="text-xl text-gray-600">CO-FOUNDER & ACQUISITIONS</p>
              </div>
            </div>
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-lg text-gray-700 mb-6">
                  Mattéo Nathan, co-fondateur de Second Souffle, apporte une perspective internationale unique grâce à son expérience en France et aux États-Unis. En tant que responsable des partenariats et de la sélection des projets, il joue un rôle clé dans l'identification et le développement des opportunités cinématographiques.
                </p>
                <p className="text-lg text-gray-700 mb-6">
                  Sa passion pour le cinéma et sa compréhension approfondie de l'industrie font de lui un interlocuteur privilégié pour les producteurs et réalisateurs souhaitant collaborer avec Second Souffle.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-3">
                  <li className="flex items-center gap-3">
                    ...
                    <span className="text-lg text-gray-700">Développement de partenariats internationaux</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <span className="text-amber-400">✦</span>
                    <span className="text-lg text-gray-700">Sélection et acquisition de projets</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <span className="text-amber-400">✦</span>
                    <span className="text-lg text-gray-700">Relations avec les producteurs et réalisateurs</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <span className="text-amber-400">✦</span>
                    <span className="text-lg text-gray-700">Développement de projets créatifs</span>
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <Link
                  href="https://www.linkedin.com/in/matteo-nathan/"
                  target="_blank"
