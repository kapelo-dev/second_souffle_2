      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              <h1 className="text-6xl font-serif text-black mb-4">Stéphane Revil</h1>
              <p className="text-2xl text-gray-600 mb-8">Managing Partner</p>
              <div className="prose prose-lg max-w-none">
                <p className="text-xl text-gray-800 mb-8">
                  Avec plus de 15 ans d'expérience dans la production audiovisuelle, Stéphane est la force motrice de Second Souffle. Son expertise et son réseau dans l'industrie font de lui un pilier essentiel dans la réalisation de nos objectifs ambitieux.
                </p>
                <h2 className="text-3xl font-serif text-black mt-12 mb-6">Parcours</h2>
                <ul className="list-disc pl-6 space-y-4 text-xl text-gray-800">
                  <li>Plus de 15 ans d'expérience en production audiovisuelle</li>
                  <li>Direction de projets cinématographiques majeurs</li>
                  <li>Développement de partenariats stratégiques</li>
                  <li>Expertise en gestion de production</li>
                </ul>
            ...
            <div className="relative aspect-[3/4] rounded-lg overflow-hidden">
              <Image
                src="/stephan.png"
                alt="Stéphane Revil - Managing Partner"
                fill
