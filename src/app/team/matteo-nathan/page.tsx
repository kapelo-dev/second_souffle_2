      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              <h1 className="text-6xl font-serif text-black mb-4">Mattéo Nathan</h1>
              <p className="text-2xl text-gray-600 mb-8">Co-Founder & Acquisitions</p>
              <div className="prose prose-lg max-w-none">
                <p className="text-xl text-gray-800 mb-8">
                  Responsable des partenariats et de la sélection des projets, Mattéo apporte une perspective internationale grâce à son expérience en France et aux États-Unis. Passionné de musique et de cinéma, il est le contact principal pour les producteurs et réalisateurs désireux de collaborer avec Second Souffle.
                </p>
                <h2 className="text-3xl font-serif text-black mt-12 mb-6">Expertise</h2>
                <ul className="list-disc pl-6 space-y-4 text-xl text-gray-800">
                  <li>Développement de partenariats internationaux</li>
                  <li>Sélection et évaluation de projets</li>
                  <li>Relations avec les créateurs</li>
            ...
            <div className="relative aspect-[3/4] rounded-lg overflow-hidden">
              <Image
                src="/mateo.png"
                alt="Mattéo Nathan - Co-Founder & Acquisitions"
                fill
